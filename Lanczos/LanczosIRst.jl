# Lanczos Implicit restart
function LanczosIRst!(W::Matrix,V::Matrix,Tm::Matrix,fv::Vector,fw::Vector,k::Int,kmax::Int,Nev::Int)
...
#----------------------------------------------------------------------
function ArnBIRst(V::Matrix,Hes::Matrix,b::Int,B::Union{Vector,Matrix},k::Int,kmax::Int,Nev::Int,ngs::Int)
