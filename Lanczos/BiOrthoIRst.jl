...
function BiOrthoIRst3!(V::Matrix,W::Matrix,Hv::Matrix,Hw::Matrix,fv::Vector,fw::Vector,k::Int,kmax::Int,Nev::Int,ngs::Int)
...
#      Hs,Q  = FrancisSeqExact(H,b,μ,nμ)
      ...
      Hsw   = Qv'*(Hv[1:kk,1:kk]')*Qv

      w     = W[:,1:kk]*Qv[:,Nev+1]        # Part of new residual vector
      βw    = Hsv[Nev+1,Nev]'              # e_k+1^T*H*e_k         # This in principle is zero
