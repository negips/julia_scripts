function IRLanczos!(Vin::Matrix,Win::Matrix,Hes::Matrix,B::Union{Vector,Matrix},w::Vector,v::Vector,k::Int,kmax::Int,Mi::Int,Nev,ngs::Int)
...
#   Update Arnoldi Vector
    h,β,r         = LanczosUpd(V,b,B,v,k,ngs)
    k             = k +1
    if (k<=kmax+b)
      V[:,k]      = r
      nkryl       = k
