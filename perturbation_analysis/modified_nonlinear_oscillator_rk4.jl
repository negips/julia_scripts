println("Modified Nonlinear Oscillator")
println("Model: x'' + αx' + x + ϵx^2 = 0")
...
#---------------------------------------------------------------------- 
function modnonosci_rk4!(y,x,α,ϵ,dt)
