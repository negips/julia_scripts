...
γa                = prec(4.0)       # Diffusion (activator)
...
A0Off             = prec(1.71)         # Homogeneous state value
B0Off             = prec(1.6)        # Homogeneous state value
ζ0Off             = prec(0.0)         # Homogeneous state value

Off0              = zeros(prec,nflds)
Off0              = [B0Off; A0Off; ζ0Off]

σai               = prec(4.0)         # Initial Activator Noise
σbi               = prec(1.0)         # Initial Inhibitor Noise Strength
