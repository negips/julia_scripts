...
#        yA        = FAC*[0.0;  0.32;   4.0]
    ...
    elseif nullcline_set == 211
#----------------------------------------       
      println("Spatial Variations")
...
#        yA        = FAC*[0.0;  0.32;   4.0]
    ...
    elseif nullcline_set == 214
#----------------------------------------       
      println("One Sided Triangles - 2")
...
#        yA        = FAC*[0.0;  -3.0;  3.0]
    ...
    elseif nullcline_set == 217
#----------------------------------------       
      println("Inverted Spots - 2")
...
@doc """
   ...
   function GetNullClineParams(nullcline_set)
            ...
            Null-cline Sets: 1         : Pulses
                           ...
                           : 56        : Dynamic Switching (λ) passing through the origin
                           :
                           ...
                           :211        : Spatial Variations
                           :212        : Spots
                           :213        : Spots - 2
                           :214        : One-Sided Triangles - 2
                           :215        : Sierpinski Triangles - 2
                           :216        : Spots - 3
                           :217        : Inverted Spots - 2
                           :218        : Spots - 4
