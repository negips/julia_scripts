...
b0 = b0_a
b  = b0
aa = find_zeros(Adotx,arange0_a,arange1_a)
a  = aa[1]
...
for n in 1:nroots
  ...
  b   = b0_a
  global an  = find_zeros(Adotx,arange0_a,arange1_a);
  b   = b0_a + dτ
  global an1 = find_zeros(Adotx,arange0_a,arange1_a);
...
plot(aroots_b,aroots_a,linestyle="-",color=cm(0))

#---------------------------------------------------------------------- 

# Null-Cline for the Inhibitor
...
b0 = b0_b
b  = b0
aa = find_zeros(Bdotx,arange0_b,arange1_b)
a  = aa[1]
...
for n in 1:nroots
  ...
  b   = b0
  global an  = find_zeros(Bdotx,arange0_b,arange1_b);
  b   = b0 + dτ
  global an1 = find_zeros(Bdotx,arange0_b,arange1_b);
...
plot(broots_b,broots_a,linestyle="-",color=cm(1))
