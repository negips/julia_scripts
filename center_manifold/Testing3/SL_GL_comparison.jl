...
file2 = "SL_resonant_Parametric1.jld2"

file3 = "GL_nonresonant_Parametric1.jld2"
file4 = "GL_resonant_Parametric1.jld2"
#-------------------------------------------------- 
...
for ik in 1:nk
  ax1.plot(GL1_xg,abs.(GL1_v[:,ik]),linewidth=1,linestyle="-",color=cm(ik-1))
end  
...
for ik in 1:nk
  ...
  ax1.plot(SL1_xg,abs.(SL1_fld[ind1]),linewidth=2,linestyle="--",color=cm(ik-1),marker="o",markevery=10)
end
...
for ik in 1:nk
  ax2.plot(GL1_xg,abs.(GL2_v[:,ik]),linewidth=1,linestyle="-",color=cm(ik-1))
end  
...
for ik in 1:nk
  ...
  ax2.plot(SL2_xg,abs.(SL2_fld[ind1]),linewidth=2,linestyle="--",color=cm(ik-1),marker="o",markevery=10)
end
