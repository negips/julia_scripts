...
ax1.plot(LinRange(1,Total_Years,Total_Years),qcap_pr,linestyle="--",color=cm(2))
...
ax1.plot(LinRange(1,Total_Years,Total_Years),hcap_pr,linestyle="--",color=cm(3))
...
ax1.plot(LinRange(1,Total_Years,Total_Years),tfcap_pr,linestyle="--",color=cm(4))
...
ax1.plot(LinRange(1,Total_Years,Total_Years),fcap_pr,linestyle="--",color=cm(5))
